...
- **Maximum gas amount**: The [maximum gas amount](./gas-txn-fee.md#specifying-gas-fees-within-a-transaction) is the maximum gas units the transaction is allowed to consume.

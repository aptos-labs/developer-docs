...
2. To set who can create a new asset, edit the `.env` file and update `VITE_COLLECTION_CREATOR_ADDRESS` to be the address of the account allowed to create assets.
...
4. Create or get the account you want to create a asset with, open the `.env` file and assign the account address as the `VITE_COLLECTION_CREATOR_ADDRESS` value.

...
本常见问题解答的目的是帮助您理解当您为节点运行 NHC 时，为什么节点没有通过某个特定的健康检查。如果您在这个 FAQ 中没有找到您想要的信息，请[提交到 ssue](https://github.com/aptos-labs/aptos-core/issues/new/choose)，或者[提交 PR](https://github.com/aptos-labs/aptos-core/pulls)，然后添加您的问题内容。

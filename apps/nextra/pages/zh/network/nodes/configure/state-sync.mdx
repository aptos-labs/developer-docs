...
- **开发网**：要同步整个区块链历史，请使用[智能同步](./state-sync.mdx#intelligent-syncing)。否则，使用[快速同步](./state-sync.mdx#fast-syncing)。
- **测试网**：要同步整个区块链历史，请从[备份](../bootstrap-fullnode/aptos-db-restore.mdx)中恢复。否则，下载[快照](../bootstrap-fullnode.mdx)或使用[快速同步](./state-sync.mdx#fast-syncing)。
- **主网**：要同步整个区块链历史，请从[备份](../bootstrap-fullnode/aptos-db-restore.mdx)中恢复。否则，使用[快速同步](./state-sync.mdx#fast-syncing)。

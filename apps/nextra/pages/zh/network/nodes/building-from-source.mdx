...
Aptos 可以在包括 Linux、macOS 和 Windows 在内的各种操作系统上构建。Aptos 在 Linux 和 macOS 上经过了广泛的测试，而在 Windows 上的测试较少。这里是我们使用的版本：
...
查看[选择网络](../../build/advanced-guides/system-integrators-guide.mdx)了解它们之间的区别。

<details>
<summary>发布分支</summary>
<Tabs groupName="release-branches" height="175px">
...
无论你选择哪种机制来安装这些依赖项，**你必须保持你的整个工具链为最新版本**。
如果你稍后遇到问题，请更新所有的包然后重试。
...
如果你对 macOS 或 Linux 设置使用了 `scripts/dev_setup.sh`，附加工具是可选用的。

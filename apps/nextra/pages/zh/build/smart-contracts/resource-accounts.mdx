...
[Object Code Deployment](deployment.mdx) is the preferred method for deploying and upgrading smart contracts in Aptos. Resource accounts require developers to generate seeds

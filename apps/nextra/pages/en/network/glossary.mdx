...
- **Command line interface** refers to the Aptos CLI used for developing on the
  ...
  at [Use the Aptos CLI](../build/cli/use-cli.mdx).
...
- You can use the faucet in a few different ways:
  - With the [Aptos CLI](../build/cli/use-cli/trying-things-on-chain/create-test-accounts.mdx).
  ...
  - With a direct HTTP request. Learn how to do
    this [here](../build/advanced-guides/system-integrators-guide.mdx#calling-the-faucet-other-languages).
...
- A **fungible asset** is an asset, such as a currency, share, in-game resource,
  ...
  APT for another.
- Follow the [Asset Standards](../build/move/standards.mdx#asset-standards) to create
...
See [Gas and Storage Fees](./blockchain/learn-about-aptos/gas-txn-fee.mdx) for more information.
...
See [Gas and Storage Fees](./blockchain/learn-about-aptos/gas-txn-fee.mdx) for
more information.
...
- Move is a safe and secure programming language for web3 that emphasizes access
  ...
  in [Move on Aptos](../build/move.mdx). { /* TODO add move-on-aptos landing page */}
...
follow [Move scripts](../build/move/learn-move/aptos-framework/scripts/script-tutorial.mdx). {/*
TODO: This tutorial seems to have disappeared
and the [Your First Multisig](../) tutorial. */}
...
- A [dapp](#dapp) that uses randomness for its functionality.
...
See [Resource accounts](../build/move/learn-move/aptos-framework/resource-accounts.mdx) for
instructions on use.

...
- [_Resource account_](../../build/smart-contracts/resource-accounts.mdx) - An autonomous account without a corresponding private key used by developers to store resources or publish modules on-chain.
- [_Object_](../../build/smart-contracts/objects.mdx) - A complex set of resources stored within a single address representing a single entity.

...
![Module event example](/docs/module-event.png "Module event example")
...
There is support for querying both module events and EventHandle events using the [GraphQL API](../../../build/advanced-guides/system-integrators-guide.mdx#production-network-access).

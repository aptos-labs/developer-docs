...
- [Cryptography primitives](../../../build/move/learn-move/aptos-framework/cryptography.mdx) for building scalable, privacy-preserving dapps.
- [Resource accounts](../../../build/move/learn-move/aptos-framework/resource-accounts.mdx) that offer programmable accounts on-chain, which can be useful for DAOs (decentralized autonomous organizations), shared accounts, or building complex applications on-chain.
...
Developers can begin their journey in Move by heading over to our [Move developer page](../../../build/move.mdx).

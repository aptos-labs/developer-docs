...
- [Cryptography primitives](../../../build/move/move-on-aptos/cryptography.mdx) for building scalable, privacy-preserving dapps.
- [Resource accounts](../../../build/move/move-on-aptos/resource-accounts.mdx) that offer programmable accounts on-chain, which can be useful for DAOs (decentralized autonomous organizations), shared accounts, or building complex applications on-chain.

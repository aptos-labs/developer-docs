...
throughput. The impact of this can be felt in the block close speed. As of December 2024, Aptos blocks close within 250ms.
...
Since its release, [Polygon](https://polygon.technology/blog/innovating-the-main-chain-a-polygon-pos-study-in-parallelization), [Sei](https://forum.sei.io/t/optimistic-concurrency-control/28), 

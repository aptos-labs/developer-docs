...
If you are a [staking pool](staking.mdx) voter, follow the instructions for voting [here](../nodes/validator-node/connect-nodes/staking-pool-voter.mdx).

If you are a [delegated staker](delegated-staking.mdx), follow the instructions for voting [here](../nodes/validator-node/connect-nodes/staking-pool-voter.mdx#delegation-pool-voter).

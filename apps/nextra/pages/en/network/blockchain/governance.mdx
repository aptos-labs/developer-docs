...
If you are a [staking pool](staking.mdx) voter, follow the instructions for voting [her../nodes/validator-node/connect-nodes/staking-pool-voter.mdxmdx).

If you are a [delegated staker](delegated-staking.mdx), follow the instructions for voting [her../nodes/validator-node/connect-nodes/staking-pool-voter.mdxmdx#delegation-pool-voter).

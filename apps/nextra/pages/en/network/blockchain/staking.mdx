...
<Callout type="info">
We strongly recommend that you read the consensus section of [Aptos Blockchain Deep Dive](blockchain-deep-dive.mdx#consensus) before proceeding further.
</Callout>
...
<Callout type="info">
See [Staking pool operations](../nodes/validator-node/connect-nodes/staking-pool-operations.mdx) for the correct sequence of commands to run for the below flow.
</Callout>
...
<Callout type="info">
For step-by-step instructions on how to join the validator set, see: [Joining Validator Set](../nodes/validator-node/connect-nodes/connect-to-aptos-network.mdx#join-the-validator-set).
</Callout>
...
1. Operator [requests commission unlock](../nodes/validator-node/connect-nodes/staking-pool-operations.mdx#requesting-commission)
...
- [Staking Pool Operations](../nodes/validator-node/connect-nodes/staking-pool-operations.mdx)
- [Delegation Pool Operations](../nodes/validator-node/connect-nodes/delegation-pool-operations.mdx)

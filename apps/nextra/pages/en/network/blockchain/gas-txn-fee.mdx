...
3. The events emitted
   For details, see [How Base Gas Works](base-gas.mdx).
...
See [Gas Profiling](../../build/cli/use-cli/working-with-move-contracts/local-simulation-benchmarking-and-gas-profiling.mdx#gas-profiling) for more details.

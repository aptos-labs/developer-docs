...
- [Cryptography primitives](../../build/smart-contracts/learn-move/advanced-guides/cryptography.mdx) for building scalable, privacy-preserving dapps.
- [Resource accounts](../../build/smart-contracts/learn-move/advanced-guides/resource-accounts.mdx) that offer programmable accounts on-chain, which can be useful for DAOs (decentralized autonomous organizations), shared accounts, or building complex applications on-chain.

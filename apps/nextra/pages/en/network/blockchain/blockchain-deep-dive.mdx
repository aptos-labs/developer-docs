...
| [Maximum gas amount](../glossary.mdx#maximum-gas-amount)                    | The maximum gas amount in APT Alice is willing to pay for this transaction. Gas charges are equal to the base gas cost covered by computation and IO multiplied by the gas price. Gas costs also include storage with an Apt-fixed priced storage model. This is represented in [Octas](../glossary.mdx#octa).                                                                                                                                                                                                                                |

...
See full list of [Delegation Pool Operations](../nodes/validator-node/connect-nodes/delegation-pool-operations.mdx)
...
[How Validation on the Aptos blockchain works](staking.mdx#validation-on-the-aptos-blockchain)
...
2. [Run command to get delegation pool address](../nodes/validator-node/connect-nodes/delegation-pool-operations.mdx#prerequisites)
3. [Operator connects to the network using pool address derived in step 2](../nodes/validator-node/connect-nodes/connect-to-aptos-network.mdx)
4. [Owner initializes the delegation pool and sets operator](../nodes/validator-node/connect-nodes/delegation-pool-operations.mdx#initialize-a-delegation-pool)
...
<Callout type="info">
  ...
  Validator
  Set](../nodes/validator-node/connect-nodes/connect-to-aptos-network.mdx#join-the-validator-set).
</Callout>
...
2. Delegator stake
3. [Validator rewards performance](staking.mdx#rewards-formula)

See [Computing delegation pool rewards](../nodes/validator-node/connect-nodes/delegation-pool-operations.mdx#compute-delegation-pool-rewards-earned)

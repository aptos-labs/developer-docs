...
If you are a node operator, [update your nodes with the new release](../nodes/full-node/modify/update-fullnode-with-new-releases.mdx).
...
Follow @AptosRelease on Twitter to get the latest updates about our upcoming
mainnet releases and be notified when it is time to update your node. Every
couple of days, @AptosRelease will tweet a countdown to remind you to update to

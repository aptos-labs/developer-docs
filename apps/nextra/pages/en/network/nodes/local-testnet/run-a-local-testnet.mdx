...
Running a local testnet with the Aptos CLI is simpler and more fully featured. Learn how by following this guide: [Run a Local Development Network with the CLI](../../nodes/local-testnet/local-development-network.mdx).
</Callout>

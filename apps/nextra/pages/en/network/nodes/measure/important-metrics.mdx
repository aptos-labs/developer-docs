...
[consensus](../../blockchain/blockchain-deep-dive.mdx#consensus) metrics are important:
...
state), the following [state sync](../configure/state-sync.mdx) metrics are important:
...
The following [mempool](../../blockchain/blockchain-deep-dive.mdx#mempool) metrics are important:

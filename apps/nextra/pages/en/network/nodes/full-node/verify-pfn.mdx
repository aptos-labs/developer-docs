...
1. Update your node to the latest release by following the [Update your Node](../full-node/modify/update-fullnode-with-new-releases.mdx).
2. Remove any `seed` peers you may have added to your configuration file. The seeds may be preventing you from
   connecting to the network. Seed peers are discussed in the [Connecting your PFN to seed peers](../full-node/modify/fullnode-network-connections.mdx#connecting-to-seed-peers) section.

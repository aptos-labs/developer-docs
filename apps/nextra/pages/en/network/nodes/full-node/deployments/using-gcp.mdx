...
If you want to configure your node with a static identity, first see the [Generate a PFN Identity](../../full-node/modify/network-identity-fullnode.mdx) tutorial
...
[Generate a PFN Identity](../modify/fullnode-network-connections.mdx) for more information.

...
[staking requirements](../../../blockchain/learn-about-aptos/staking.mdx#minimum-and-maximum-stake) for the
...
pools in the [Staking](../../../blockchain/learn-about-aptos/staking.mdx) and [Delegated Staking](../../../blockchain/learn-about-aptos/delegated-staking.mdx) sections.

To initialize a staking pool, follow the instructions in
[staking pool operations](../../../nodes/validator-node/connect-nodes/staking-pool-operations.mdx#initialize-a-staking-pool). Otherwise,
to initialize a delegation pool, follow the instructions in
[delegation pool operations](../../../nodes/validator-node/connect-nodes/delegation-pool-operations.mdx#initialize-a-delegation-pool).
...
correctly, visit the [Node Health](../../validator-node/verify-nodes/node-liveness-criteria.mdx) document. This document describes how you can verify and

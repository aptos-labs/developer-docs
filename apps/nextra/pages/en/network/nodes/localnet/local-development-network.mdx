...
- Aptos CLI: [Installation Guide](../../../build/cli/install-cli.mdx).
...
Once you see this final line, you know the localnet is ready to use:
...
### How do I publish Move modules to the localnet?
...
If you are new to the Aptos CLI see this comprehensive [Aptos CLI user documentation](../../../build/cli/use-cli.mdx).

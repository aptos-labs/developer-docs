...
For deploying a local network with a single node, see [Run a Local Development Network with the CLI](./local-development-network.mdx).
</Callout>

## Before you proceed

This guide assumes you have done the steps in [Building Aptos From Source](../building-from-source.mdx)

...
See [Choose a network](./system-integrators-guide.md#choose-a-network) for an
...
skip the prover tests.  To install the prover (optional), follow the [Prover guide](../../build/move/prover.mdx)

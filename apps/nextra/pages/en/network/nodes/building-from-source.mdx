...
[Binary releases are available](../../build/cli/install-cli.mdx), but if you want to build from source or develop on the Aptos tools, this is how.
...
See [Choose a network](./system-integrators-guide.md#choose-a-network) for an explanation of their differences.
...
[Using the released SDK can be achieved from npm/pnpm/yarn](../../build/sdks/index.mdx).
...
- [Indexer](../../build/indexer/index.mdx)
- [Node Health Checker](./measure/node-health-checker.mdx)
- [Running a Local Multi-node Network](./localnet/running-a-local-multi-node-network.mdx)

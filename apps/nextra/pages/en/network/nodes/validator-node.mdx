...
Before initializing a staking pool or delegation pool, read about [Staking](../blockchain/learn-about-aptos/staking.mdx) and
[Delegated Staking](../blockchain/learn-about-aptos/delegated-staking.mdx) to learn the

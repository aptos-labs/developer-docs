...
import { Callout, MathJax, MathJaxContext } from 'nextra/components'
...
You can still use [Markdown and MDX syntax](markdown.mdx) in the same line as your LaTeX expression.

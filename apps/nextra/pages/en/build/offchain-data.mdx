...
Indexer layer on top of this will provide a [GRPC transaction stream](./indexer/txn-stream/labs-hosted.mdx)
...
![bq_sql](../../../public/screenshots/bq_sql.png)

We also have sample analytics queries [using the above resources](https://console.cloud.google.com/marketplace/product/bigquery-public-data/crypto-aptos-mainnet-us)

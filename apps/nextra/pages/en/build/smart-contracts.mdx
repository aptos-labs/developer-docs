...
Smart contracts on Aptos are implemented using Move, a rust-based programming language built for security and verification. 
...
- [Aptos Move Book](smart-contracts/learn-move/book.mdx) to teach you many of the general Move concepts.
...
- [Aptos Move Framework](../network/blockchain/move.mdx).{/* TODO: fix reference link */}

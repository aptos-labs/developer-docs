...
<Callout type="info">
The complete code example can be found at the bottom of this page!
</Callout>
...
This will initialize a typescript package with `index.ts`

```bash npm2yarn
npm init && npm add -D typescript @types/node ts-node && npx tsc --init && mkdir src && echo 'console.log("Hello, TypeScript!");' > src/index.ts
```

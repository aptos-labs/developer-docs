...
2. **The `function` being called on-chain.** <br/>This is the identifier for the smart contract entry function on-chain that will trigger when we execute this transaction.

...
Behind the scenes, the Aptos SDK has two formats for transactions:

1. **Simple** - This represents transactions using primitive types like strings, integers, etc.

...
Normally, the account that is executing a transaction pays for the gas fees. We can allow another account to cover those charges though by sponsoring a transaction.

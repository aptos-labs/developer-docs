...
Once you have created a `.graphql` file with a GraphQL query, you can generate TypeScript code based on that query, so you can use it with the TypeScript SDK by running the following command:

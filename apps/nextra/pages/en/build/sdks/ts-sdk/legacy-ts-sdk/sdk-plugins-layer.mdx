...
The [AptosToken](https://github.com/aptos-labs/aptos-core/blob/main/ecosystem/typescript/sdk/src/plugins/aptos_token.ts) class is compatible with the [Aptos Digital Asset Standard](../../../move/aptos-framework/digital-asset.mdx) and provides methods for creating and querying NFT collections and tokens.
...
The [TokenClient](https://github.com/aptos-labs/aptos-core/blob/main/ecosystem/typescript/sdk/src/plugins/token_client.ts) class is compatible with the [token V1 standard](../../../move/aptos-framework/aptos-token.mdx) and provides methods for creating and querying the NFT collections and tokens.
...
The [FungibleAssetsClient](https://github.com/aptos-labs/aptos-core/blob/main/ecosystem/typescript/sdk/src/plugins/fungible_asset_client.ts) class is compatible with the [fungible asset component](../../../move/aptos-framework/fungible-asset.mdx) and provides methods to transfer fungible assets between accounts and to check an account balance.

...
More specifically, this provides a flexible and secure way to manage cross-chain signatures. (see [cross chain wallets](../../wallet-adapter/cross-chain-wallet.mdx))

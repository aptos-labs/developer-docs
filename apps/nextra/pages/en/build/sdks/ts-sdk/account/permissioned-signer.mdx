...
<Callout>
 Visit the [Permissioned Signer Example Project](https://github.com/aptos-labs/aptos-connect/tree/main/apps/examples/permissioned-signer) for a complete example of how to use Permissioned Signer with the TS-SDK.
</Callout>

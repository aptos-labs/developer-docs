...
<Callout type="info">
This documentation is for the **legacy TypeScript SDK**, aka `aptos`. For a more robust and better SDK support, we recommend upgrading to the **new TypeScript SDK** [@aptos-labs/ts-sdk](https://github.com/aptos-labs/aptos-ts-sdk). Take a look at the [documentation](../ts-sdk.mdx) and the [migration guide](./legacy-ts-sdk/migration-guide.mdx)
</Callout>
...
See the [TypeScript SDK Architecture](./legacy-ts-sdk/typescript-sdk-overview.mdx) for the components that make up the TypeScript SDK.

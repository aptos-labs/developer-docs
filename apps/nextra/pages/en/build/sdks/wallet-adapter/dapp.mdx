...
## Follow The AIP-62 Wallet Standard
...
```jsx
// include only Petra AIP-62 compatible wallet
...
To support both Legacy and AIP-62 standards, dapp should provide a wallets array to the React
...
## Follow the Legacy Wallet Standard

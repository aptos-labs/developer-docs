...
<Callout type="info">
  This step is to implement only by chrome extension wallets. i.e if the wallet is a SDK wallet (npm package) there is no need to use this logic
</Callout>

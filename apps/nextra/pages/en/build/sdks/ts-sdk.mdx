...
You can send transactions to change the state of the ledger. Transactions let you send tokens like APT, trigger Move modules, trade NFTs, and more. You can find an in-depth tutorial on transactions [here](./ts-sdk/building-transactions.mdx).
...
3. Looking up data from on-chain using client helper functions like [`aptos.getAccountModules`](https://aptos-labs.github.io/aptos-ts-sdk/@aptos-labs/ts-sdk-1.13.1/classes/Aptos.html#signAndSubmitTransaction).
...
{/* TODO: Add this after figuring out what code snippet to have for it. - 3. [Testing With a Local Network](./ts-sdk/local-network.mdx) */}

...
our [Wallet Standard](../standards/wallets.mdx). This in turns allows dapps to
...
guide [here](../advanced-guides/integrate-with-aptos/wallet-adapter/dapp.mdx#aip-62-wallet-standard) and Wallets
can follow the integration
guide [here](../advanced-guides/integrate-with-aptos/wallet-adapter/wallets.mdx#aip-62-wallet-standard)
:::
...
Follow the [Wallet Adapter For Dapp Builders](../advanced-guides/integrate-with-aptos/wallet-adapter/dapp.mdx)
...
Follow the [Wallet Adapter For Wallet Builders](../advanced-guides/integrate-with-aptos/wallet-adapter/wallets.mdx)

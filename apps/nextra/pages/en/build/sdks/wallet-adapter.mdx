...
2. For [SDK Wallets](./wallet-adapter/sdk-wallets.mdx) (ex. [T Wallet](https://www.npmjs.com/package/@atomrigslab/aptos-wallet-adapter))
...
- [Wallet Adapter React Package](https://github.com/aptos-labs/aptos-wallet-adapter/tree/main/packages/wallet-adapter-react)
    - [Dapp developer usage guide](https://aptos.dev/en/build/sdks/wallet-adapter/dapp)

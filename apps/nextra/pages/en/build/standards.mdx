...
### [Aptos Object](./standards/aptos-object.md)
...
### [Digital Asset (DA)](./standards/digital-asset.md)
...
### [Fungible Asset (FA)](./standards/fungible-asset.md)
...
- [Wallet adapter](../integration/wallet-adapter-concept.md) so that all
applications can interact seamlessly with a common interface.

## Legacy Standards

### [Aptos Token](./standards/aptos-token.md)
...
### [Aptos Coin](./standards/aptos-coin.md)

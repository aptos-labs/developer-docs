---
title: "Aptos Token Standard (Legacy)"
---
...
<Callout type="info">
  **Aptos Token standards compared**<br />
  Also see the [comparison of Aptos Token
  standards](../guides/nfts/aptos-token-overview.md). {/* TODO fix link*/}
</Callout>
...
You should store the metadata in a JSON file located in an off-chain storage
solution such as [arweave](https://www.arweave.org/) and provide the URL to the
...
The [following diagram](/docs/aptos-token-standard-flow.svg) depicts the
flow of token data through Aptos.
...
creator’s account and the owner’s account.

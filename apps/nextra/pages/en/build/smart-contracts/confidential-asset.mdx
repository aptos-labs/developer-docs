...
<Callout type="info">
  ...
  Cryptographic and mathematical details are explained superficially but more in-depth information can be found [here](https://).
</Callout>
...
- [Confidential Asset SDK](https://)
- [Confidential Asset Whitepaper](https://)
- [Confidential Asset Contracts](https://)
- [Confidential Asset Move Examples](https://)

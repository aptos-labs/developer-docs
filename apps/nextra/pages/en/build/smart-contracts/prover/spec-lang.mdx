...
[Move](../../smart-contracts.mdx) language that supports specification of the
...
[Move module](../../../network/glossary.mdx#move-module) or
[Move script](../../../network/glossary.mdx#move-script). At the

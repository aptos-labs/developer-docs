...
The Move Prover supports formal [specification](prover/spec-lang.mdx) and
[verification](prover/prover-guide.mdx) of Move code. The Move Prover can
...
- [Installation](../../cli/install-cli/install-move-prover.mdx)
- [Move Prover User Guide](prover/prover-guide.mdx)
- [Move Specification Language](prover/spec-lang.mdx)
- [Move Prover Supporting Resources](prover/supporting-resources.mdx)

...
This tutorial explains how to write and execute a [Move script](../../book/modules-and-scripts.mdx). You can use Move scripts to execute a series of commands across published Move module interfaces.

For more information about scripts, see the [Move scripts docs](../scripts.mdx)
...
Let us run through how to execute a Move script with a step-by-step example using the [Aptos CLI](../../../../cli/use-cli/working-with-move-contracts.mdx).
...
2. Set up the Aptos CLI and [create an account](../../../../cli/cli-configuration.mdx):

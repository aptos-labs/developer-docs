...
[Object standard](../../aptos-standards/aptos-object.mdx) page, and view the code at the
[framework generated object documentation](../../../../network/blockchain/move.mdx). {/* TODO: Fix link */ }
...
- [Creating objects](objects/creating-objects.mdx)
- [Configuring objects](objects/configuring-objects.mdx)
- [Using objects](objects/using-objects.mdx)

# More details

For more details on objects, checkout:

- [Object standards](../../aptos-standards/aptos-object.mdx) page.
- [Framework generated object documentation](/reference/move/##?branch=mainnet&page=aptos-framework/doc/object.md) {/* TODO: Fix link */}

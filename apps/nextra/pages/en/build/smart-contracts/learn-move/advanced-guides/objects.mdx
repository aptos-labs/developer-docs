...
[Object standard](../../aptos-framework/aptos-object.mdx) page, and view the code at the
[framework generated object documentation](../../../reference/move.md). {/* TODO: Fix link */ }
...
- [Using objects](./objectsusing-objects.mdx)

# More details

For more details on objects, checkout:

- [Object standards](../../aptos-framework/aptos-object.mdx) page.

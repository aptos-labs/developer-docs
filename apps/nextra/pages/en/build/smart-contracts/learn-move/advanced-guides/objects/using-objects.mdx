...
disabled.
See [disabling transfer of an object](configuring-objects.mdx#disabling-or-re-enabling-transfers).
...
see [allowing deletion of an object](configuring-objects.mdx#allowing-deletion-of-an-object).

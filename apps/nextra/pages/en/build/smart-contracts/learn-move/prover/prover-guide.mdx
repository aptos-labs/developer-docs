...
[Move specification language](spec-lang.mdx). See the sections below for details.

## Running the Move Prover

The Move Prover is invoked via the [Aptos CLI](../../../cli/use-cli.mdx). In order
to call the CLI, you must have a [_Move package_](../book/packages.mdx) in place.
...
[Proving Move](../../../cli/use-cli/working-with-move-contracts.mdx#6-optional-formally-verifying-move-scripts)

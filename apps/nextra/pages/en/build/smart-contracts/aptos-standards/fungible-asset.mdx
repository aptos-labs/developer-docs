...
Asides from the default fungible asset functionality, a Fungible Asset creator can implement their own deposit and withdraw logic using dispatchable fungible assets. Creating a custom hook would allow for fungible asset creator to implement more complex logic such as customized access control or taxes.

For more details please see [AIP-73](https://github.com/aptos-foundation/AIPs/blob/main/aips/aip-73.md).

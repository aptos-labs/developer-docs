...
Function info can be constructed using the following function:
...
For security, you will need to pass in the signer of the module to create the `FunctionInfo` functions in the module.  If using the previous example you would call:

```move 
module 0x42::my_fungible_asset {

...
More details on these limitations can be found in [AIP-73](https://github.com/aptos-foundation/AIPs/blob/main/aips/aip-73.md).

### Register the hook function

Once the module containing the hook functions is published, call `dispatchable_fungible_asset::register_dispatch_functions` to bind the functions with your fungible asset.

...
The [Aptos Digital Asset Standard](./digital-asset.mdx) defines the
...
the [Move object](./aptos-object.mdx) data model.
...
The [accounts](../../network/blockchain/learn-about-aptos/accounts.mdx) in Aptos store both smart contracts
and data. Unlike Ethereum, the associated data of a smart contract is
distributed across the space of all accounts
in [resources](../../network/blockchain/learn-about-aptos/resources.mdx)
within [accounts](../../network/blockchain/learn-about-aptos/accounts.mdx)
or [objects](./aptos-object.mdx). For example, a collection and an

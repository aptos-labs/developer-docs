...
### [Aptos Object](aptos-standards/aptos-object.mdx)
...
### [Digital Asset (DA)](aptos-standards/digital-asset.mdx)
...
### [Fungible Asset (FA)](aptos-standards/fungible-asset.mdx)
...
### [Aptos Wallet](../sdks/wallet-adapter/wallets.mdx)
...
- [Wallet adapter](../sdks/wallet-adapter.mdx) so that all {/* TODO fix link */}
applications can interact seamlessly with a common interface.

## Legacy Standards

### [Aptos Token](aptos-standards/aptos-token.mdx)
...
### [Aptos Coin](aptos-standards/aptos-coin.mdx)

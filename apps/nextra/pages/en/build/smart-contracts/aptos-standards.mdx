...
### [Aptos Object](move/aptos-framework/aptos-object.mdx)
...
### [Digital Asset (DA)](move/aptos-framework/digital-asset.mdx)
...
functionalities. An example of this is the [aptos_token module](https://github.com/aptos-labs/aptos-core/blob/main/aptos-move/framework/aptos-token-objects/sources/aptos_token.move)

Digital Asset (DA) is recommended for any new collections or protocols that want
to build NFT or semi-fungible tokens.

### [Fungible Asset (FA)](move/aptos-framework/fungible-asset.mdx)
...
### [Aptos Wallet](move/aptos-framework/wallets.mdx)

The Wallet standard ensures that all wallets use the same functionality for key
features. This includes:

- The same mnemonic so that wallets can be moved between providers.
- [Wallet adapter](../integration/wallet-adapter-concept.mdx) so that all {/* TODO fix link */}
applications can interact seamlessly with a common interface.

## Legacy Standards

### [Aptos Token](move/aptos-framework/aptos-token.mdx)
...
### [Aptos Coin](move/aptos-framework/aptos-coin.mdx)

...
Up-to-date document on `vector` can be found [here](https://github.com/aptos-labs/aptos-core/blob/main/aptos-move/framework/move-stdlib/doc/vector.mdx#0x1_vector).
...
For more details see the sections on [type abilities](abilities.mdx) and [generics](generics.mdx).

...
Normally, developers of such applications would have to wait until their desired cryptographic functionality is implemented efficiently as a [Move native function](book/functions.mdx#native-functions) in the [Aptos Move framework](../../network/blockchain/move.mdx).

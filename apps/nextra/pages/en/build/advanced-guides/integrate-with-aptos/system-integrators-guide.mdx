...
See [Aptos Blockchain Networks](../../../network/nodes/networks.mdx) for full details on each
environment.
...
- Directly [run a localnet](../../../network/nodes/localnet/run-a-localnet.mdx) using either
the [Aptos-core source code](../../../network/nodes/localnet/run-a-localnet.mdx).
...
- A strictly
increasing [sequence number](../../../network/blockchain/accounts.mdx)

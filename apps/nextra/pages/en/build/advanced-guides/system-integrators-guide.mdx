...
a [local development network](../cli/running-a-local-network.mdx).
...
the account resources URL:
  ...
  conduct ["Your first transaction"](../tutorials/first-transaction.mdx). {/*TODO fix tutorial links */}
{/* TODO FIX tutorial links */}
To learn more about coin creation,
make ["Your First Coin"](../tutorials/first-coin.mdx).
...
existing [SDK](../tutorials/first-transaction.mdx) {/* TODO fix tutorial links */}

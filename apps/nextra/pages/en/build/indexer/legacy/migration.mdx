...
This new way of indexing uses the [Transaction Stream Service](../txn-stream.mdx). You can either use the [Labs-Hosted Transaction Stream Service](../aptos-hosted.mdx) or [run your own instance of Transaction Stream Service](../api/self-hosted.mdx).
...
The main benefit of using the Labs-Hosted Transaction Stream Service is that you no longer need to run an archival fullnode to get a stream of transactions. This service is rate-limited. Instructions to connect to Labs-Hosted Transaction Stream can be found [here](../aptos-hosted.mdx).

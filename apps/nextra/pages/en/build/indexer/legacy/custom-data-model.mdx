...
This is documentation for the legacy indexer. To learn how to write a custom processor with the latest indexer stack, see [Custom Processors](../custom-processors.mdx).
</Callout>
...
```rust filename="coin_balance.move"

...
`getNameFromAddress` looks up the active human readable name registered for the given account. For example, a user could register their account with the Aptos Name Service to be associated to `love.apt`. You can learn more by going to https://www.aptosnames.com/.

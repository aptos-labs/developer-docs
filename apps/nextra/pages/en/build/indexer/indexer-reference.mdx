...
You can also find a list of the most common queries using these tables [here](common-queries.mdx).
...
| ----------------------------- | ------- | ----------- | ---------------------------------------------------------------------------------------------------------- |
| coin_activities               | Join    |             | Use the [Hasura explorer](#indexer-api-reference) to see these sub-fields.                                 |
| coin_activities_aggregate     | Join    |             | Use the [Hasura explorer](#indexer-api-reference) to see these sub-fields.                                 |
| delegated_staking_activities  | Join    |             | Use the [Hasura explorer](#indexer-api-reference) to see these sub-fields.                                 |
| fungible_asset_activities     | Join    |             | References [fungible_asset_activities](#fungible_asset_activities).                                        |
| token_activities              | Join    |             | Use the [Hasura explorer](#indexer-api-reference) to see these sub-fields.                                 |
| token_activities_aggregate    | Join    |             | Use the [Hasura explorer](#indexer-api-reference) to see these sub-fields.                                 |
...
| Field                      | Type    | Primary Key | Description                                                                                                                              |
| -------------------------- | ------- | ----------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| aptos_names_from           | Join    |             | Use the [Hasura explorer](#indexer-api-reference) to see these sub-fields.                                                               |
| aptos_names_from_aggregate | Join    |             | Use the [Hasura explorer](#indexer-api-reference) to see these sub-fields.                                                               |
| aptos_names_to             | Join    |             | Use the [Hasura explorer](#indexer-api-reference) to see these sub-fields.                                                               |
| aptos_names_to_aggregate   | Join    |             | Use the [Hasura explorer](#indexer-api-reference) to see these sub-fields.                                                               |
| current_token_data         | Join    |             | Use the [Hasura explorer](#indexer-api-reference) to see these sub-fields.                                                               |
...
| Field                              | Type    | Primary Key | Description                                                                                                                      |
| ---------------------------------- | ------- | ----------- | -------------------------------------------------------------------------------------------------------------------------------- |
| cdn_asset_uris                     | Join    |             | Use the [Hasura explorer](#indexer-api-reference) to see these sub-fields.                                                       |
| current_collection                 | Join    |             | Use the [Hasura explorer](#indexer-api-reference) to see these sub-fields.                                                       |
| current_token_ownerships           | Join    |             | Use the [Hasura explorer](#indexer-api-reference) to see these sub-fields.                                                       |
| current_token_ownerships_aggregate | Join    |             | Use the [Hasura explorer](#indexer-api-reference) to see these sub-fields.                                                       |

...
You can learn more about the Transaction Stream Service architecture [here](../txn-stream.mdx) and the Docker compose file [here](https://github.com/aptos-labs/aptos-core/blob/main/docker/compose/indexer-grpc/docker-compose.yaml).

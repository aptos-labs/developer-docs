...
If you want to use the [Move Prover](../../move/prover/index.mdx), install the Move Prover dependencies after [installing the CLI binary](.).

1. See [Building Aptos From Source](../../guides/building-from-source.mdx)

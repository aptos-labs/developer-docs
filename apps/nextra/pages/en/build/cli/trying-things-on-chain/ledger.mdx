...
<Callout type="default" emoji="🧠">
For ease of identification this account has vanity address `0xaaaa...aaaa`, which was generated via [`optivanity`](https://github.com/econia-labs/optivanity).
</Callout>
...
Note that the `jq` authentication key is the same as the account address:
...
Rotate the authentication key of the hot wallet via [`aptos_framework::account::rotate_authentication_key_call`](https://github.com/aptos-labs/aptos-core/blob/415d7e12e94ebd833a910ed4138742f005149610/aptos-move/framework/aptos-framework/sources/account.move#L294):
...
This is what `private_key_before_rotation` and `public_key_before_rotation` are for.
</Callout>

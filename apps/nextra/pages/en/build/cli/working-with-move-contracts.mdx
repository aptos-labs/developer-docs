...
You can estimate the gas fees associated with publishing your Move contract by using the [Gas Profiler](../../move/move-on-aptos/gas-profiling.mdx). {/* TODO: Fix this link */}
...
For cases where you want to guarantee that your code works as expected beyond unit testing, you can use the [Move Prover](../smart-contracts/learn-move/prover.mdx) to formally verify your Move contract code.

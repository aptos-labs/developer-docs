...
1. Ensure you have the Aptos CLI installed. You can install the Aptos CLI by following [these steps](../../cli/install-cli/install-cli.mdx) if you have not done so already.

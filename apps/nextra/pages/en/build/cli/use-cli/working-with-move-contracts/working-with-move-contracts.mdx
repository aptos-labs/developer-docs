...
To see how to chain together Move contracts on-chain using the CLI, you can follow this [“CLI Arguments” tutorial](./arguments-in-json-tutorial.mdx).
...
You can install the Move Prover by following [these steps](../../aptos-cli/install-cli/install-move-prover.mdx).

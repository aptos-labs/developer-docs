...
Alternatively, if you are interested in replaying a past transaction, check out [this tutorial](../replay-past-transactions).
...
Notice that you do need to have your CLI profile set up properly and bind the named addresses correctly. Please refer to [CLI Configuration](../../cli-configuration.md) for more details.

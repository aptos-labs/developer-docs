...
Alternatively, if you want to simulate a new transaction, check out [Local Simulation, Benchmarking and Gas Profiling](working-with-move-contracts/local-simulation-benchmarking-and-gas-profiling).
...
To understand the gas report, please refer to [this section](working-with-move-contracts/local-simulation-benchmarking-and-gas-profiling#understanding-the-gas-report) of the local simulation tutorial.
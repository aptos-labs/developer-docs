...
<Callout type="info">
Also see the [System Integrators Guide](../advanced-guides/integrate-with-aptos/system-integrators-guide.mdx) {/* TODO fix link */} for a thorough walkthrough of Aptos integration.
</Callout>
...
As with the [Aptos Indexer](../indexer/api/labs-hosted.mdx), the Aptos REST API has a rate limit of 5000
...
The view function operates like the [Aptos Simulation API](../advanced-guides/integrate-with-aptos/system-integrators-guide.mdx), {/* TODO: Fix link */}
...
In order to use the View functions, you need to [publish the module](../cli/use-cli/working-with-move-contracts.mdx)

...
<Callout type="info">
Also see the [System Integrators Guide](../advanced-guides/system-integrators-guide.mdx) for a thorough walkthrough of Aptos integration.
</Callout>
...
The view function operates like the [Aptos Simulation API](../advanced-guides/system-integrators-guide.mdx),

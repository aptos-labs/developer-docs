...
As with the [Aptos Indexer](../indexer/api/labs-hosted.mdx#rate-limits), the Aptos REST API has a rate limit of 5000
...
- As transactions execute, they may emit events. [Events](../../network/blockchain/learn-about-aptos/events.mdx) are hints about changes in on-chain
data.
...
retrieving state from [validator fullnodes](../../network/blockchain/learn-about-aptos/fullnodes.mdx), which in turn rely upon
[validator nodes](../../network/blockchain/learn-about-aptos/validator-nodes.mdx) as the source of truth.
</Callout>
...
The view function operates like the [Aptos Simulation API](../guides/system-integrators-guide.md#testing-transactions-or-transaction-pre-execution), {/* TODO: Fix link */}
...
In order to use the View functions, you need to [publish the module](../cli/use-cli/working-with-move-contracts.mdx#4-publishing-move-contracts)
through the [Aptos CLI](../cli/use-cli.mdx).

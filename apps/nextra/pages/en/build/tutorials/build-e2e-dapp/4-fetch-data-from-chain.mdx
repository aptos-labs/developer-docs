...
In the fourth chapter of the tutorial on [building an end-to-end dapp on Aptos](../../../index.mdx), you will be learning to fetch data from chain.
...
To fetch data from chain, we can use the [Aptos TypeScript SDK](../../../index.mdx). The SDK provides classes and functions for us to easily interact and query the Aptos chain.

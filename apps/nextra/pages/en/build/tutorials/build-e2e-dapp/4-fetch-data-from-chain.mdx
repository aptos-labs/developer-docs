...
<Callout type="info">
By default, `Aptos` will interact with the `devnet` network, to set up a [different network](../../advanced-guides/system-integrators-guide.mdx#choose-a-network), we can use `AptosConfig` class.

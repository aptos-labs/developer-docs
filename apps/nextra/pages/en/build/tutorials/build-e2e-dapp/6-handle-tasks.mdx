...
In the sixth and final chapter of the tutorial on [building an end-to-end dapp on Aptos](../../../index.mdx), you will add functionality to the app so the user interface is able to handle cases where an account has created a list.

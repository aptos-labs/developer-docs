...
This is the first chapter of the tutorial on [building an end-to-end dapp on Aptos](../../../index.mdx). If you haven’t done it, review that introduction, and ensure your environment meets the [prerequisites](../../../index.mdx) listed there.

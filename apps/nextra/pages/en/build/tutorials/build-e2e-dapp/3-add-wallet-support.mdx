...
In the third chapter of the tutorial on [building an end-to-end dapp on Aptos](./index.md), you will be adding _wallet_ support to your [React app](2-set-up-react-app.mdx). You now need a wallet to submit a transaction to the blockchain.

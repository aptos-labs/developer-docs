...
The `transfer-coin` example code uses helper functions to interact with the [REST API](../../network/nodes/aptos-api-spec.mdx). This section reviews each of the calls and gives insights into functionality.

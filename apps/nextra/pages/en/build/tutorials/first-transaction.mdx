...
```python
:!: /sdks/python/examples/transfer_coin.py section_1
```
...
```rust
:!: /sdks/rust/examples/transfer-coin.rs section_1a
```
...
```rust
:!: /sdks/rust/examples/transfer-coin.rs section_1b
```

In the example we initialize the URL values as such:

```rust
:!: /sdks/rust/examples/transfer-coin.rs section_1c
```
...
```python
:!: /sdks/python/examples/transfer_coin.py section_2
```
...
```rust
:!: /sdks/rust/examples/transfer-coin.rs section_2
```
...
```python
:!: /sdks/python/examples/transfer_coin.py section_3
```
...
```rust
:!: /sdks/rust/examples/transfer-coin.rs section_3
```
...
```python
:!: /sdks/python/examples/transfer_coin.py section_4
```
...
```rust
:!: /sdks/rust/examples/transfer-coin.rs section_4
```
...
```python
:!: /sdks/python/examples/transfer_coin.py section_5
```

Behind the scenes the Python SDK generates, signs, and submits a transaction:

```python
:!: /sdks/python/aptos_sdk/async_client.py bcs_transfer
```
...
```rust
:!: /sdks/rust/examples/transfer-coin.rs section_5
```

Behind the scenes the Rust SDK generates, signs, and submits a transaction:

```rust
:!: /sdks/rust/src/coin_client.rs section_1
```
...
```python
:!: /sdks/python/examples/transfer_coin.py section_6
```
...
```rust
:!: /sdks/rust/examples/transfer-coin.rs section_6
```

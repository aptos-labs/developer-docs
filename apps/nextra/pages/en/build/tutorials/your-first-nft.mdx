...
Both the collection and token assets are [Objects](../smart-contracts/aptos-standards/aptos-object.mdx) on-chain with unique addresses. Their metadata is stored at the object address. The SDKs provide convenience wrappers around querying this data:

...
<Tabs items={['typescript', 'python']}>
  <Tabs.Tab value="typescript" label="Typescript">
...
```python
:!: /sdks/python/examples/simple_aptos_token.py section_1a
```
...
```python
:!: /sdks/python/examples/simple_aptos_token.py section_1b
```
...
```python
:!: /sdks/python/examples/common.py section_1
```
...
```python
:!: /sdks/python/examples/simple_aptos_token.py section_2
```
...
```python
:!: /sdks/python/examples/simple_aptos_token.py section_3
```
...
```python
:!: /sdks/python/examples/simple_aptos_token.py section_4
```

This is the function signature of `create_collection`. It returns a transaction hash:

```python
:!: /sdks/python/aptos_sdk/aptos_token_client.py create_collection
```
...
```python
:!: /sdks/python/examples/simple_aptos_token.py section_5
```

This is the function signature of `mint_token`. It returns a transaction hash:

```python
:!: /sdks/python/aptos_sdk/aptos_token_client.py mint_token
```
...
```python
:!: /sdks/python/examples/simple_aptos_token.py section_6
```

To read a token's metadata:

```python
:!: /sdks/python/examples/simple_aptos_token.py get_token_data
```
...
:!: /sdks/python/examples/simple_aptos_token.py section_7
```

```python title="How the owners dictionary is defined"
:!: /sdks/python/examples/simple_aptos_token.py owners
```
...
:!: /sdks/python/examples/simple_aptos_token.py section_8
```

```python title="How the transfer_token function is defined"
:!: /sdks/python/aptos_sdk/aptos_token_client.py transfer_token
```

```python title="Read the owner"
:!: /sdks/python/examples/simple_aptos_token.py section_9
```

```python title="Transfer the token back to Alice"
:!: /sdks/python/examples/simple_aptos_token.py section_10
```

```python title="Read the owner again"
:!: /sdks/python/examples/simple_aptos_token.py section_11
```

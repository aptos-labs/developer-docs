...
- As transactions execute, they may emit events. [Events](../concepts/events.md) are hints about changes in on-chain
data. {/* TODO: Fix link */}
...
retrieving state from [validator fullnodes](../concepts/fullnodes.md), {/* TODO Fix link */} which in turn rely upon

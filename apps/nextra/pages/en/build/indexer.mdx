...
For example, you can use the Indexer API to look up the coin balances of any account like so:
...
<Cards>
  ...
  <Card href="indexer/custom-processors">
    ...
    <Card.Description>Extend the Indexer to track even more relevant data.</Card.Description>
  </Card>
</Cards>

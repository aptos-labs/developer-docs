    ...
    <Steps>
      ...
      <Tabs items={['JetBrains IDE', 'VSCode']}>
        ...
        <Tabs.Tab>
          ...
          <Cards>
            <Card
              href="https://marketplace.visualstudio.com/items?itemName=zktxio.aptos-extension">
              <Card.Title linkType="external">Aptos Extension</Card.Title>
              <Card.Description>Tools for compiling, deploying, and testing Aptos smart contracts in 
              VS Code with GitHub Codespaces support.</Card.Description>
            </Card>
          </Cards>
        </Tabs.Tab>
      </Tabs>

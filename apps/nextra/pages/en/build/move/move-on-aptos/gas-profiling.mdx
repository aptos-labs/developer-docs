...
Once activated, it will simulate transactions using an instrumented VM, and generate a web-based report. [Sample report](/gas-profiling/sample-report/index.html)
...
Notice that you do need to have your CLI profile set up properly and bind the named addresses correctly. Please refer to [CLI Configuration](../../cli/cli-configuration.mdx) for more details.
...
<FileTree>
  <FileTree.Folder name="my_project" defaultOpen>
    ...
    <FileTree.Folder name="gas-profiling" defaultOpen>
      <FileTree.Folder name="txn-xxxxxxxx-0x1-code-publish_package_txn"
                       defaultOpen>
...
```text filename="Example gas report"

...
Generics can be used to define functions and structs over different input data types. When using them, ensure that the generic types are valid and what’s expected. [Read more](../book/generics/) about generics.
...
[Read more](../move/book/abilities/) about abilities.
...
[Read more](../move/book/integers/#operations) about operations.
...
[Read more](../../standards/aptos-object/) about Aptos Objects.

...
This document goes through how you can deploy code to [Objects](./objects). This is the recommended way to deploy code to the blockchain, as this reduces deployment complexity,

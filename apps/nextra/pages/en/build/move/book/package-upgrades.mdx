...
Move code upgrades on the Aptos blockchain happen at the [Move package](./packages.mdx)
...
[Aptos CLI](../../cli/use-cli/working-with-move-contracts.mdx). For an example,
see the [Your First Move Module](../../tutorials/first-move-module.mdx) tutorial. {/* TODO fix link */}
...
see [Aptos Governance](../../../network/blockchain/learn-about-aptos/governance.mdx).

...
- Prove the sources of the package in the current directory:
  ...
  aptos move prove
  ```
- Prove the sources of the package in a specific directlry:
  ```bash filename="Terminal"
  aptos move prove --package-dir <path>
  ```
See example output and other available options in the [Proving Move](../../cli/use-cli/working-with-move-contracts.mdx#6-optional-formally-verifying-move-scripts) section of Use Aptos CLI.

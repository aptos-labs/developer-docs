...
[Move](../move-on-aptos.mdx) language that supports specification of the
behavior of Move programs. MSL works together with the [Move Prover](../prover.mdx),
...
[Move module](../../reference/glossary.md#move-module) or { /* TODO: Fix link */ }
[Move script](../../reference/glossary.md#transaction-or-move-script). At the
...
This document describes the language only; see [Use the Move Prover](./prover-guide.mdx)

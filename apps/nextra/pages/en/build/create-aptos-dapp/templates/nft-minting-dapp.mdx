...
2. Modify a premade generated front end UI to build a NFT minting dapp.
3. Learn how to write a Move contract and front end connected to that contract. 

In addition, it offers a beautiful pre-made UI for a NFT minting dapp users can quickly adjust and deploy into a live server.

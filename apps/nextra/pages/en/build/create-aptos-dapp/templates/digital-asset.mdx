...
This will create the contract for minting your collection, as well as setting the `VITE_MODULE_ADDRESS` in the `.env` file to set which account will own the minted collections.

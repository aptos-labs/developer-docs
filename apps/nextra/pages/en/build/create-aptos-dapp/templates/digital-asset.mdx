...
You will need this to run the contract to create a collection. Make sure to set up the account on the same network as your template project.
...
The CLI will prompt you to provide the private key for your wallet in order for the tool to make the collection on your behalf.  If you provide no input, it will generate one for you.

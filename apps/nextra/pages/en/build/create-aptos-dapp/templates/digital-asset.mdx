...
1. "Public Mint NFT" - A page for the public to mint NFTs.
2. "Create Collection" - A page for creating new NFT collections. This page is not accessible in production.
3. "My Collections" - A page to view all the collections created with the template Move module. This page is also not accessible in production.

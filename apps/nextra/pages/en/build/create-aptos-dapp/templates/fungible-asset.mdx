...
3. Run `npm run move:publish` to publish the contract.
...
6. Create or get the account you want to create a asset with, open the `.env` file and assign the account address as the `VITE_COLLECTION_CREATOR_ADDRESS` value.

...
Sign up for [Neon postgres](https://neon.tech/) which is our cloud Postgres provider and create a new project. Find the connection string and set it in the `.env` file as `DATABASE_URL`.

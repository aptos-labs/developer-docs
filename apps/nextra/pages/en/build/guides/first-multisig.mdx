...
<Callout type="info">
On Windows, use `python --version` instead (without the '3').
</Callout>
...
Open `multisig.py` in your text editor and add the following code:
...
<Callout type="info">
On Windows, use `python multisig.py` instead (without the '3').
</Callout>
...
You can run the code to verify the output:
...
<Callout type="info">
On Windows, remember to use `python multisig.py` instead.
</Callout>
...
Run the code to verify funding success:
...
<Callout type="info">
Remember, use `python multisig.py` instead.
</Callout>
...
Run the script to see the transaction results:

...
<Callout type="info">
This tutorial is not meant to teach you the fundamentals of Move. That is a longer topic best learned through the [Move Book](../smart-contracts/book.mdx). If you need more analogies to familiar concepts like OOP, Solidity, or driving, check out the Developers Journey blog.
</Callout>
...
1. Ensure you have [installed the Aptos CLI](../cli.mdx).
...
3. If you're building an application to interact with contracts or look up data from on-chain, learn how to use the SDKs [here](../sdks/index.mdx).

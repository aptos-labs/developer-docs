...
<Callout type="info">
This tutorial is not meant to teach you the fundamentals of Move. That is a longer topic best learned through the [Move Book](../smart-contracts/book). If you need more analogies to familiar concepts like OOP, Solidity, or driving, check out the Developers Journey blog.
</Callout>

...
In the fourth chapter of the tutorial on [building an end-to-end dapp on Aptos](../build-e2e-dapp.mdx), you will be submitting data to the chain.
...
Since you haven’t made the user interface able to handle cases where an account has created a list, you will do so next [handling tasks](5-handle-tasks.mdx) in chapter 5.

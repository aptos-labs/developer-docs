...
| Apple             | Live      | Live    | Live    |
| Auth0 (Federated) | Live      | Live    | -       |
| Cognito (Federated)| Live      | Live    | -       |
| Okta              | In review | -       | -       |
| Microsoft         | In review | -       | -       |
| Github            | In review | -       | -       |
| Facebook          | In review | -       | -       |
...
<Callout type="info">
  **Federated Keyless**
  ...
  Support for federated Keyless Accounts via IAM providers such as Auth0 and Cognito is coming soon.  
  
  For the latest updates join us here: https://t.me/+h5CN-W35yUFiYzkx
</Callout>

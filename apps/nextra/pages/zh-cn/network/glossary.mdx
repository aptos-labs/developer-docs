...
follow [Move scripts](../build/smart-contracts/learn-move/advanced-guides/scripts/script-tutorial.mdx). {/*
...
See [Resource accounts](../build/smart-contracts/learn-move/advanced-guides/resource-accounts.mdx) for
instructions on use.

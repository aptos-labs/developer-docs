...
If you are running your own instance of the [Indexer API](../api.mdx), or a [custom processor](../custom-processors.mdx), you must have access to an instance of the Transaction Stream Service. This page contains information about how to use the Labs-Hosted Transaction Stream Service.
...
If you need a higher rate limit, consider running the Transaction Stream Service yourself. See the guide to self-hosting [here](../api/self-hosted.mdx).
--> */}
...
- [Indexer API](../api/self-hosted.mdx)

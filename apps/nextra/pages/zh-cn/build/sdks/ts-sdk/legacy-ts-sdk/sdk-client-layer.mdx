...
The Provider class extends both [AptosClient](sdk-client-layer/aptos-client.mdx) and [IndexerClient](sdk-client-layer/indexer-client.mdx) classes and gives the end user the option to simply create a Provider instance and call a method by hiding the underlying implementation. If, for any reason, you want to use AptosClient or IndexerClient directly without the Provider class, you are able to do it.

...
If you do not need this advanced method, you can find the normal install steps [here](../install-cli.mdx).
...
<Steps>
### Follow the steps to build Aptos from source here: https://aptos.dev/guides/building-from-source/.
### Ensure you have `cargo` installed by following the steps on [this page](https://doc.rust-lang.org/cargo/getting-started/installation.html#install-rust-and-cargo).
### Build the CLI tool: `cargo build --package aptos --profile cli`.

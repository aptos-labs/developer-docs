...
The Aptos Node Health Checker (NHC) service can be used to check the health of your node(s). See [Node Health Checker](node-health-checker.mdx) for full documentation on the NHC.

...
# 公式SDK
これらのAptos ソフトウェア開発キット（SDK）は、[Aptos CLI](cli.mdx)と組み合わせてAptosブロックチェーン上の開発に使用できます。
...
<Cards className="xl:grid-cols-2">
  ...
  <Card href="./sdks/wallet-adapter" className="flex flex-row gap-4">
    ...
    <div className="flex flex-col gap-2">
      <Card.Title>ウォレットアダプター</Card.Title>
      <Card.Description>
        Aptos ウォレットアダプター
      </Card.Description>
    </div>
...
## [コミュニティSDK](./sdks/community-sdks.mdx)

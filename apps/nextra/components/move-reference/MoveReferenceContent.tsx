import { MDXComponents, useMDXComponents } from 'nextra/mdx'
...
export function MoveReferenceContent({
  compiledSource,
  scope,
  components
}: {
  /**
   * Compiled Source from /api/compile-mdx
   */
  compiledSource: any;
  /**
...
MoveReferenceContent.useTOC = (props: Record<string, unknown>) => {
  // const compiledSource = useData('__nextra_dynamic_mdx')
  const { useTOC } = evaluate(props.compiledSource as any)
  return useTOC(props)
}
